    ...
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            This local dashboard template does not include a login system by default. Any product
            data shown in the template is demo data used to preview the interface and development
            workflow.
          </p>
        </section>
